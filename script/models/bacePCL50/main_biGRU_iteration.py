...
for number in seedList:
    ...
    model = model_biGRU(argsLstm).to(device)
    ...
    result['y'] = y
    resultPath = '../../../result/seedRandom/bacePLC50/turePred/result-gru(ecfp)-{}.csv'.format(number)
    ...
    df.to_csv('../../../result/seedRandom/bacePLC50/rmseMaeR-gru.csv', index=False)
