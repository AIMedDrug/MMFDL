...
savePath = '../../../result/seed42/bacePLC50/dyweight/{}_rmseMae_{}_{}_{}_weight_com.csv'.format(label, batch_size, epochs, random_state)
rmseAndMae(yResult, savePath)
savePath = '../../../result/seed42/bacePLC50/dyweight/{}_weight_{}_{}_{}_weight_com.csv'.format(label, batch_size, epochs, random_state)
df_weight = pd.DataFrame(weightDic.items(), columns=['Key', 'Value'])
df_weight.to_csv(savePath, index=False)

savePath = '../../../result/seed42/bacePLC50/dyweight/{}_scatter_predited_{}_{}_{}_com.png'.format(label, batch_size, epochs, random_state)
...
result['y_pred'] = yPred
result['y'] = ySour
resultPath = '../../../result/seed42/bacePLC50/dyweight/{}-result-{}-{}-{}-com.csv'.format(label, batch_size, epochs, random_state)
resultDf = pd.DataFrame(result)
resultDf.to_csv(resultPath, index=False)
print(resultPath + '\tsaved successfully')
print('\n')

savePath = '../../../result/seed42/bacePLC50/dyweight/{}_loss_{}_{}_{}_weight_com.png'.format(label, batch_size, epochs, random_state)
plotLoss(resultLoss['losses_train'], resultLoss['losses_val'], savePath)


savePath = '../../../pth/bacePLC50/{}_{}_{}_{}_dyweight_com.pth'.format(label, batch_size, epochs, random_state)
torch.save(com_model.state_dict(), savePath)
print(savePath + '\tsave succeed!')

savePath = '../../../pth/bacePLC50/{}_{}_{}_{}_dyweight_com_args.pkl'.format(label, batch_size, epochs, random_state)
with open(savePath, 'wb') as pickle_file:
    pickle.dump(argsCom, pickle_file)
print(savePath + '\tsave succeed!')    


savePath = '../../../result/seed42/bacePLC50/dyweight/{}_validation_{}_{}_{}_data.csv'.format(label, batch_size, epochs, random_state)
