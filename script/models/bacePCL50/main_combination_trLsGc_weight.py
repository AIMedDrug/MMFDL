...
savePath = '../../../result/seed42/bacePLC50/weight/{}_rmseMae_{}_{}_{}_weight_com.csv'.format(label, batch_size, epochs, random_state)
rmseAndMae(yResult, savePath)
savePath = '../../../result/seed42/bacePLC50/weight/{}_weight_{}_{}_{}_weight_com.csv'.format(label, batch_size, epochs, random_state)
df_weight = pd.DataFrame(weightDic)
df_weight.to_csv(savePath, index=False)

savePath = '../../../result/seed42/bacePLC50/weight/{}_scatter_predited_{}_{}_{}_lasso_com.png'.format(label, batch_size, epochs, random_state)
pltPredict_linregress(y_lasso, y_sour, savePath)
savePath = '../../../result/seed42/bacePLC50/weight/{}_scatter_predited_{}_{}_{}_elastic_com.png'.format(label, batch_size, epochs, random_state)
pltPredict_linregress(y_ela, y_sour, savePath)
savePath = '../../../result/seed42/bacePLC50/weight/{}_scatter_predited_{}_{}_{}_rf_com.png'.format(label, batch_size, epochs, random_state)
pltPredict_linregress(y_tree, y_sour, savePath)
savePath = '../../../result/seed42/bacePLC50/weight/{}_scatter_predited_{}_{}_{}_gradient_com.png'.format(label, batch_size, epochs, random_state)
...
result['y'] = y_sour
resultPath = '../../../result/seed42/bacePLC50/weight/{}-result-{}-{}-{}-lasso-com.csv'.format(label, batch_size, epochs, random_state)
...
result['y_pred'] = y_ela
result['y'] = y_sour
resultPath = '../../../result/seed42/bacePLC50/weight/{}-result-{}-{}-{}-elastic-com.csv'.format(label, batch_size, epochs, random_state)
resultDf = pd.DataFrame(result)
resultDf.to_csv(resultPath, index=False)
print(resultPath + '\tsaved successfully')
result = {}
...
result['y'] = y_sour
resultPath = '../../../result/seed42/bacePLC50/weight/{}-result-{}-{}-{}-rf-com.csv'.format(label, batch_size, epochs, random_state)
resultDf = pd.DataFrame(result)
resultDf.to_csv(resultPath, index=False)
print(resultPath + '\tsaved successfully')
result = {}
...
result['y'] = y_sour
resultPath = '../../../result/seed42/bacePLC50/weight/{}-result-{}-{}-{}-gradient-com.csv'.format(label, batch_size, epochs, random_state)
resultDf = pd.DataFrame(result)
resultDf.to_csv(resultPath, index=False)
print(resultPath + '\tsaved successfully')
print('\n')

savePath = '../../../result/seed42/bacePLC50/weight/{}_loss_{}_{}_{}_weight_com.png'.format(label, batch_size, epochs, random_state)
plotLoss(resultLoss['losses_train'], resultLoss['losses_val'], savePath)

savePath = '../../../result/seed42/bacePLC50/weight/{}_loss_{}_{}_{}_weight_com.csv'.format(label, batch_size, epochs, random_state)
lossDf = pd.DataFrame(resultLoss)
lossDf.to_csv(savePath, index=False)


savePath = '../../../result/seed42/bace/weight/{}_validation_{}_{}_{}_data.csv'.format(label, batch_size, epochs, random_state)
