...
for number in seedList:
    ...
    result['y'] = y_sour
    resultPath = '../../../result/seedRandom/bacePLC50/turePred/fusion/result-lasso-{}.csv'.format(number)
    ...
    result['y_pred'] = y_ela
    result['y'] = y_sour
    resultPath = '../../../result/seedRandom/bacePLC50/turePred/fusion/result-elastic-{}.csv'.format(number)
    resultDf = pd.DataFrame(result)
    resultDf.to_csv(resultPath, index=False)
    ...
    result['y'] = y_sour
    resultPath = '../../../result/seedRandom/bacePLC50/turePred/fusion/result-rf-{}.csv'.format(number)
    resultDf = pd.DataFrame(result)
    resultDf.to_csv(resultPath, index=False)
    ...
    result['y'] = y_sour
    resultPath = '../../../result/seedRandom/bacePLC50/turePred/fusion/result-GB-{}.csv'.format(number)
    resultDf = pd.DataFrame(result)
    resultDf.to_csv(resultPath, index=False)


    df = pd.DataFrame(resultWeight)
    df.to_csv('../../../result/seedRandom/bacePLC50/rmseMaeR-comMachine-weight.csv', index=False)

    df = pd.DataFrame(resultDataLasso)
    df.to_csv('../../../result/seedRandom/bacePLC50/rmseMaeR-comMachine-lasso.csv', index=False)

    df = pd.DataFrame(resultDataEla)
    df.to_csv('../../../result/seedRandom/bacePLC50/rmseMaeR-comMachine-elastic.csv', index=False)

    df = pd.DataFrame(resultDataRf)
    df.to_csv('../../../result/seedRandom/bacePLC50/rmseMaeR-comMachine-rf.csv', index=False)

    df = pd.DataFrame(resultDataGra)
    df.to_csv('../../../result/seedRandom/bacePLC50/rmseMaeR-comMachine-gradient.csv', index=False)
