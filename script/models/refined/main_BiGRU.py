...
savePath = '../../../result/seed42/refined/{}_rmseMae_{}_{}_{}_BiGRU(ep).csv'.format(label, batch_size, epochs, random_state)
rmseAndMae(yResult, savePath)


savePath = '../../../result/seed42/refined/{}_scatter_predited_{}_{}_{}_BiGRU(ep).png'.format(label, batch_size, epochs, random_state)
...
result['y'] = y
resultPath = '../../../result/seed42/refined/{}-result-{}-{}-{}-BiGRU(ep).csv'.format(label, batch_size, epochs, random_state)
resultDf = pd.DataFrame(result)
resultDf.to_csv(resultPath, index=False)
print(resultPath + '\tsaved successfully')

savePath = '../../../result/seed42/refined/{}_loss_{}_{}_{}_BiGRU(ep).png'.format(label, batch_size, epochs, random_state)
plotLoss(resultLoss['losses_train'], resultLoss['losses_val'], savePath)

savePath = '../../../result/seed42/refined/{}_loss_{}_{}_{}_BiGRU(ep).csv'.format(label, batch_size, epochs, random_state)
